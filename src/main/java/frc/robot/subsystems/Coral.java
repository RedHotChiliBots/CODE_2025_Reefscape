...
public class Coral extends SubsystemBase {
  ...
  public void Stop() {
    leftIntake.set(Constants.Coral.STOP);
    rightIntake.set(Constants.Coral.STOP);
  }

  public void Intake() {
    leftIntake.set(Constants.Coral.INTAKE);
    rightIntake.set(Constants.Coral.INTAKE);
  }

  public void Eject() {
    leftIntake.set(Constants.Coral.EJECT);
    rightIntake.set(Constants.Coral.EJECT);
  }
}
